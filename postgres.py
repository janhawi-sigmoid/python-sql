...
class Employee:
    ...
    def get_connection(self):
        try:
            connection = psycopg2.connect(database="postgres_assignment", user="janhawishresth", password="Janhawi)*02",
    ...
    def get_engine(self):
        try:
            engine = create_engine("postgresql+psycopg2://janhawishresth:postgres@localhost:5432/postgres_assignment")
        except:
            raise Exception("Execution unsuccessful. Exception occurred.")
        return engine
